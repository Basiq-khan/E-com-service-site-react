  ...
  return (
    <section className="py-24 bg-white overflow-hidden">
      <div className="container mx-auto px-4">
        <div className="bg-[#FDF392]/30 rounded-[5px] p-12 md:p-20 relative overflow-hidden flex flex-col md:flex-row items-center gap-12 border border-[#FDF392]">
           <div className="md:w-3/5 space-y-8 relative z-10">
              <h2 className="text-4xl md:text-6xl font-black text-[#75221D] leading-[1.1]"> Ready to Dominate <br /> <span className="text-[#FE502D]">The Amazon Market?</span></h2>
           ...
           <div className="md:w-2/5 relative">
              <div className="relative w-80 h-80 md:w-96 md:h-96 bg-[#FE502D] rounded-[5px] flex items-center justify-center overflow-hidden shadow-2xl border-8 border-white">
