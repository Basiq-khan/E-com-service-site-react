    ...
    <div className="pt-20">
      ...
      <section className="bg-[#75221D] min-h-[60vh] md:h-[70vh] flex items-center relative overflow-hidden py-20 md:py-0">
        <motion.div 
          ...
          className="absolute -top-20 -left-20 w-[400px] md:w-[600px] h-[400px] md:h-[600px] bg-[#FE502D]/10 rounded-full blur-[100px]"
        />
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12 md:gap-24">
            ...
            >
              <div className="relative group px-4 md:px-0">
                  ...
                  <img src={serviceAds} alt="Listing" className="w-full h-auto relative rounded-[5px] shadow-2xl border border-gray-100 z-10 transition-transform duration-700 group-hover:scale-105" />
              </div>
            </motion.div>
            <motion.div 
          ...
          <div className="flex flex-col lg:flex-row-reverse items-center gap-12 md:gap-24">
            ...
            >
               <div className="relative group px-4 md:px-0">
                  ...
                  <img src={serviceSeo} alt="A+ Content" className="w-full h-auto relative rounded-[5px] shadow-2xl border border-white/10 z-10 transition-transform duration-700 group-hover:scale-105" />
               </div>
            </motion.div>
            <motion.div 
              initial={{ opacity: 0, y: 50 }}
      ...
      <section className="py-20 md:py-32 bg-white overflow-hidden">
        <div className="container mx-auto px-4">
           <div className="text-center mb-16 md:mb-24 space-y-4 md:space-y-6">
              ...
              <h2 className="text-[clamp(2.5rem,6vw,5.5rem)] font-black text-[#75221D] tracking-tighter uppercase italic leading-none">MAXIMIZE <span className="text-[#FE502D]">CONVERSION.</span></h2>
           </div>
