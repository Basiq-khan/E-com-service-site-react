...
export function AccountStoreSetup() {
  return (
    <div className="pt-20">
           ...
           >
             <Link to="/contact">
               <Button size="lg" className="bg-[#FE502D] hover:bg-white hover:text-[#75221D] text-white px-16 h-20 rounded-[5px] text-2xl font-black transition-all shadow-2xl uppercase italic tracking-tighter">
                 Launch My Store <ArrowRight className="ml-4 w-8 h-8" />
               </Button>
             </Link>
           </motion.div>
        </div>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-24">
            ...
            >
              <div className="relative group">
                  ...
                  <img src={serviceAds} alt="Setup" className="relative rounded-[5px] shadow-2xl border border-gray-100 z-10 transition-transform duration-700 group-hover:scale-105" />
              </div>
            </motion.div>
            <motion.div 
          ...
          <div className="flex flex-col lg:flex-row-reverse items-center gap-24">
            ...
            >
               <div className="relative group">
                  ...
                  <img src={serviceSeo} alt="Advanced Setup" className="relative rounded-[5px] shadow-2xl border border-white/10 z-10 transition-transform duration-700 group-hover:scale-105" />
               </div>
            </motion.div>
            <motion.div 
              initial={{ opacity: 0, y: 50 }}
      ...
      <section className="py-32 bg-white underline-section">
        <div className="container mx-auto px-4">
           <div className="text-center mb-24 space-y-6">
              ...
              <h2 className="text-5xl md:text-8xl font-black text-[#75221D] tracking-tighter uppercase italic">Scaling <span className="text-[#FE502D]">Simplified.</span></h2>
           </div>
