    ...
    <div className="pt-20">
      ...
      <section className="bg-[#75221D] min-h-[60vh] md:h-[70vh] flex items-center relative overflow-hidden py-20 md:py-0">
        ...
        <motion.div 
          ...
          className="absolute -top-20 -right-20 w-[400px] md:w-[500px] h-[400px] md:h-[500px] bg-[#FE502D]/20 rounded-full blur-[100px]"
        />
        ...
        <div className="container mx-auto px-4 relative z-10">
           <div className="max-w-4xl mx-auto text-center space-y-4 md:space-y-6">
              <motion.div
                ...
                className="inline-block px-6 py-2 bg-white/10 backdrop-blur-md border border-white/10 rounded-[5px] text-[#FDF392] text-[10px] md:text-xs font-black uppercase tracking-[0.3em] mb-4 md:mb-6"
              >
                Our Legacy & Mission
              </motion.div>
              <motion.h1 
      ...
      <section className="py-20 md:py-32 bg-white relative overflow-hidden">
        <div className="container mx-auto px-4 relative z-10">
          <div className="flex flex-col lg:flex-row items-center gap-12 md:gap-24">
            ...
            >
              <div className="relative group max-w-xl mx-auto lg:mx-0 px-4 md:px-0">
                  ...
                  <div className="absolute bottom-6 md:bottom-10 -right-4 md:-right-10 bg-[#FE502D] text-white p-6 md:p-10 rounded-[5px] shadow-2xl">
                    <p className="text-4xl md:text-6xl font-black leading-none">10+</p>
                    <p className="text-[10px] md:text-sm font-black uppercase tracking-widest mt-2">Years Of Growth</p>
                  </div>
              </div>
            </motion.div>
            ...
            >
              <div className="space-y-4 md:space-y-6">
                <h2 className="text-[clamp(2rem,5vw,3.5rem)] font-black text-[#75221D] leading-tight tracking-tighter uppercase italic">
        ...
        <div className="container mx-auto px-4">
           <div className="text-center mb-16 md:mb-24 space-y-4">
              <motion.p 
                ...
                className="text-[#FDF392] font-black uppercase tracking-[0.5em] text-[10px] md:text-xs"
              >
                The Brain Trust
              </motion.p>
              <h2 className="text-[clamp(2.5rem,6vw,5.5rem)] font-black tracking-tighter uppercase italic leading-none">Our <span className="text-[#FE502D]">Team.</span></h2>
           </div>
           
           <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12 md:gap-16 px-4 md:px-0">
              {[
      ...
      {/* CTA Section */}
      <section className="py-20 md:py-32 bg-[#FE502D]">
        <div className="container mx-auto px-4 text-center space-y-10 md:space-y-12">
           <h2 className="text-[clamp(2.5rem,8vw,6.5rem)] font-black text-white leading-[0.85] tracking-tighter italic uppercase">
              Ready to <br /> 
              <span className="text-[#75221D]">Scale?</span>
           </h2>
           <Link to="/contact">
             <Button className="w-full sm:w-auto bg-white text-[#FE502D] hover:bg-[#75221D] hover:text-white h-16 md:h-20 px-12 md:px-16 rounded-[5px] text-xl md:text-2xl font-black uppercase italic tracking-tighter transition-all shadow-2xl">
