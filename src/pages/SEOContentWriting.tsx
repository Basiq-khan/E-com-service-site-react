    ...
    <div className="pt-20">
      ...
      <section className="bg-[#75221D] min-h-[60vh] md:h-[70vh] flex items-center relative overflow-hidden py-20 md:py-0">
        <motion.div 
          ...
          className="absolute -bottom-20 -left-20 w-[400px] md:w-[600px] h-[400px] md:h-[600px] bg-[#FDF392]/10 rounded-full blur-[100px]"
        />
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12 md:gap-24">
            ...
            >
              <div className="relative group px-4 md:px-0">
                  ...
                  <img src={serviceAds} alt="SEO Writing" className="w-full h-auto relative rounded-[5px] shadow-2xl border border-gray-100 z-10 transition-transform duration-700 group-hover:scale-105" />
              </div>
            </motion.div>
            <motion.div 
          ...
          <div className="flex flex-col lg:flex-row-reverse items-center gap-12 md:gap-24">
            ...
            >
               <div className="relative group px-4 md:px-0">
                  ...
                  <img src={serviceSeo} alt="Advanced Copy" className="w-full h-auto relative rounded-[5px] shadow-2xl border border-white/10 z-10 transition-transform duration-700 group-hover:scale-105" />
               </div>
            </motion.div>
            <motion.div 
              initial={{ opacity: 0, y: 50 }}
      ...
      <section className="py-20 md:py-32 bg-white overflow-hidden">
        <div className="container mx-auto px-4">
           ...
           <div className="text-center mb-16 md:mb-24 space-y-4 md:space-y-6">
              ...
              <h2 className="text-[clamp(2.5rem,6vw,5.5rem)] font-black text-[#75221D] tracking-tighter uppercase italic leading-none">PREMIUM CONTENT <span className="text-[#FE502D]">STRATEGY.</span></h2>
           </div>
           ...
           <div className="text-center px-4">
             <Link to="/contact">
                <Button className="w-full sm:w-auto bg-[#75221D] text-white hover:bg-[#FE502D] h-16 md:h-20 px-12 md:px-16 rounded-[5px] text-xl md:text-2xl font-black uppercase italic tracking-tighter transition-all shadow-2xl">
                  Request Copy Audit <ArrowRight className="ml-4 w-6 h-6 md:w-8 md:h-8" />
                </Button>
             </Link>
           </div>
        </div>
